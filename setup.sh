...
startInstall() 
{
    ...
    if [[ "$NPM" == [yY] ]]; then
        ...
        curl https://raw.githubusercontent.com/ZekXtreme/docker_setup/main/docker_compose.nginx_proxy_manager.yml -o docker-compose.yml >> ~/docker-script-install.log 2>&1
    ...
    if [[ "$NAVID" == [yY] ]]; then
        ...
        curl https://raw.githubusercontent.com/ZekXtreme/docker_setup/main/docker_compose_navidrome.yml -o docker-compose.yml >> ~/docker-script-install.log 2>&1
